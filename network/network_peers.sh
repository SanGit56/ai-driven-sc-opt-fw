...
scripts/deployCC_peers.sh kanal-fabric basic ../asset-transfer-basic/chaincode-go go
...
# create config block
# peer channel create -o 10.125.169.226:7050 --ordererTLSHostnameOverride orderer.example.com -c kanal-fabric -f ../network/configtx/channel-artifacts/kanal-fabric.tx --outputBlock ../network/configtx/channel-artifacts/kanal-fabric.block --tls --cafile ../network/organizations/ordererOrganizations/example.com/tlsca/tlsca.example.com-cert.pem